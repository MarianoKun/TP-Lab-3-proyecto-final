...
//        planeList = genericFileHandler.readFile(planeList,GenericFileHandler.planesFilePath);
//        userList = genericFileHandler.readFile(userList,GenericFileHandler.usersFilePath);
//        flightList = genericFileHandler.readFile(flightList,GenericFileHandler.flightsFilePath);

//        planeList = genericFileHandler.readFileGson(planeList,GenericFileHandler.planesFilePath);
//        userList = genericFileHandler.readFileGson(userList,GenericFileHandler.usersFilePath);
//        flightList = genericFileHandler.readFileGson(flightList,GenericFileHandler.flightsFilePath);
...
//     //gsonBuilder.registerTypeAdapter(Planes.class, new LocalDateConverter());
//     //gsonBuilder.registerTypeAdapter(Planes.class, new LocalDateConverter());
...
//     gson.toJson(flightList,type,bufferedWriter);
//     bufferedWriter.close();

//
//
//     BufferedReader bufferedReader = new BufferedReader(new FileReader(file));
//        List<Flight> listaAvionesGson = gson.fromJson(bufferedReader,type);
...
//     genericFileHandler.saveFile(planeList);  // las guardo manual por ahora
//     genericFileHandler.saveFile(userList);  // las guardo manual por ahora
//     genericFileHandler.saveFile(flightList);  // las guardo manual por ahora

//     genericFileHandler.saveFileGson(userList,GenericFileHandler.usersFilePath);
//     genericFileHandler.saveFileGson(planeList,GenericFileHandler.planesFilePath);
//     genericFileHandler.saveFileGson(flightList,GenericFileHandler.flightsFilePath);
...
// endregion
       ...
       // System.out.println(bronze1.getDias());
        //System.out.println(silver4.getDias());
        //System.out.println(gold7.getDias());
...
//        for (var avion: listaAvionesGson) {
//            System.out.println(avion);
//        }
        Executable exec = new Executable(listaUsuarios,listaVuelosGson,listaAvionesGson);
        ////todo crear metodo AGREGAR AVION
...
//        users = (List<User>)genericFileHandler.readFileGson(users,GenericFileHandler.usersFilePath);
//
//        List<Planes> planes = new ArrayList<>();
//        planes =(List<Planes>) genericFileHandler.readFileGson(planes,GenericFileHandler.planesFilePath);
//
//        List<Flight> flights = new ArrayList<>();
//        flights = (List<Flight>) genericFileHandler.readFileGson(flights,GenericFileHandler.flightsFilePath);
//
//
//        for(var user: users){
//            System.out.println(user);
